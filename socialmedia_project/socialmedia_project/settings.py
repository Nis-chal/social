...
SECRET_KEY = 'django-insecure-%m3-nayvpt*d3na$gr-3xdwbho@lglk+fj7n3g1a3n^h!r-pz-'
...
INSTALLED_APPS = [
    ...
    'admins_app.apps.AdminsAppConfig',
...
EMAIL_PORT =587
EMAIL_USE_TLS = 'True'
EMAIL_HOST_USER = 'Nischallee@gmail.com'
EMAIL_HOST_PASSWORD = '########'